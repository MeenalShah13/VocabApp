...
@Composable
fun MainScreenNavHostContainer(courseViewModel: CourseViewModel, myWordsViewModel: MyWordsViewModel, navController: NavHostController, firestoreDatabase: FirebaseFirestore, context: Context, modifier: Modifier = Modifier) {
    NavHost(
        ...
        composable("Course_Screen") { CourseScreen(courseViewModel, myWordsViewModel, context, modifier) }
    }
}