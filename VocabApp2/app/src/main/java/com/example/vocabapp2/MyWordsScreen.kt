...
fun MyWordsCard(wordInfo: WordDetails, modifier: Modifier = Modifier) {
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = if (expanded) MaterialTheme.colorScheme.primaryContainer else MaterialTheme.colorScheme.secondaryContainer // Orange when expanded, light gray otherwise
        )
    ) {
        Column(
